...
import Data.Generics (everywhere, extT, listify, mkT)
import Data.List (foldl')
import Data.Map (Map)

import qualified Data.Map as Map

import Language.Haskell.Exts hiding (Lazy, Strict)
...
eApp :: Exp () -> [Exp ()] -> Exp ()
eApp f [a, b]
  | Just (QConOp () (Special _ Cons {})) <- getOp f
  , Just as <- getList b =
      List () (a : as)
...
srcSpanToRange (SrcSpan file l1 c1 l2 c2) =
  ...
  where
    pos l c = Pn () 0 (fromIntegral l) (fromIntegral c)
