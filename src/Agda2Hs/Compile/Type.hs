...
import Agda.Utils.Monad (and2M, ifM, or2M, unlessM)
...
compileType t = do
  ...
  case t of
    ...
    _ -> fail
  where
    fail = genericDocError =<< text "Bad Haskell type:" <?> prettyTCM t
